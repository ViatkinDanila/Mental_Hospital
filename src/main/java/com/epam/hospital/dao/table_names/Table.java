...
public class Table {
    ...
    public static final String CHAMBERS_TYPE_TABLE = "chambres_type";
    public static final String CONSULTATION_TABLE = "consultations";
    public static final String CONSULTATION_TYPE_TABLE = "consultation_type";
    ...
    public static final String TREATMENT_COURS_TABLE = "treatment_courses";
    public static final String TREATMENT_COURS_HAS_DISEASES_TABLE = "treatment_courses_has_diseases";
    ...
    public static final String DRUGS_RECIPES = "drug_recipes";
