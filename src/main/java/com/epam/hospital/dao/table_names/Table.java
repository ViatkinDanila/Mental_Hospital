...
public class Table {
    ...
    public static final String DRUG_RECIPES_TABLE = "drug_recipes";
    public static final String DISEASE_SYMPTOMS_TABLE = "disease_symptoms";
    public static final String CHAMBER_STAYING_TABLE = "chamber_staying";
    public static final String DOCTOR_INFO_TABLE = "doctor_info";
}
